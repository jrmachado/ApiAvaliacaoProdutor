...
public class InformacaoPremiacaoVO implements Serializable {
	...
	public InformacaoPremiacaoVO() {
		super();
	}

	public InformacaoPremiacaoVO(String producer, int interval, int previousWin, int followingWin) {
